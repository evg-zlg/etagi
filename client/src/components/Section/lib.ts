...
export function getFilteredAndSortFlats(
  ...
  if (searchParams.has(rooms)) {
    ...
    filteredFlats = filteredFlats.filter((flat) => searchValue?.includes(String(flat.rooms)));
  }

  // price
  if (searchParams.has(priceMin)) {
    const searchValue = searchParams.get(priceMin);
    filteredFlats = filteredFlats.filter((flat) => flat.price >= Number(searchValue));
  }
  ...
  if (searchParams.has(areaTotalMin)) {
    ...
    filteredFlats = filteredFlats.filter((flat) => flat.area_total >= Number(searchValue));
  }
  ...
  if (searchParams.has(areaKitchenMin)) {
    ...
    filteredFlats = filteredFlats.filter((flat) => flat.area_kitchen >= Number(searchValue));
  }
  ...
  if (searchParams.has(areaLiveMin)) {
    ...
    filteredFlats = filteredFlats.filter((flat) => flat.area_live >= Number(searchValue));
  }
  ...
  if (searchParams.has(floorMin)) {
    ...
    filteredFlats = filteredFlats.filter((flat) => flat.floor >= Number(searchValue));
  }
